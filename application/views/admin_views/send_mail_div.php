<h2>Divisions are ready mail</h2>
<?php
  ...
  <div class="row">
    <div class="col-md-8 col-md-offset-2">
      <div class="form-group">
        ...
        <?php
        echo form_open('send_mails_divs');
        $attributes = array(
          'class' => 'required'
        );
        ...
        $data = array(
          ...
          'required' => 'required',
          'id' => 'subject',
          'value' => "Stour Squash Club - New Divisions",
          'maxlength' => '150'
        );
        ...
        $data = array(
          ...
          'required' => 'required',
          'id' => 'content',
          'value' => "The new divisions are now ready. Please use Results Form to send results.",
          'rows' => '8',
          'cols' => '150'
        );
